					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="<?= base_url(); ?>assets/img/logo.jpeg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?= base_url(); ?>assets/img/logo.jpeg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4><?= $this->session->nama; ?></h4>
												<p class="text-muted"><?= $this->session->role; ?></p>
												<a href="<?= base_url(); ?>LoginAdmin/logout" class="btn btn-xs btn-secondary btn-sm">Logout</a>
											</div>
										</div>
									</li>
								</div>
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									...
									<span class="user-level"><?= $this->session->role_admin; ?></span>
